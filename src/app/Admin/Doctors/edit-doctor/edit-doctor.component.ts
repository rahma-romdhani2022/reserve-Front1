...
fileData: File = null;
 ...
 gender : string ; 
 id : number ;
 constructor(private dialog: MatDialog , private dialogRef : MatDialogRef<EditDoctorComponent> ,private service :AdminService , private userService : UserServiceService ,  private router : Router ) {}
...
modifierProfile(f:NgForm){
  this.userService.updatedata(parseInt(localStorage.getItem("idExpertAModifier")), f.value).subscribe(()=>{
    ...
    console.log(this.selectedFile);
     ...
     console.log(this.selectedFile)
     this.userService.updateImage(parseInt(localStorage.getItem("idExpertAModifier")),this.uploadImageData).subscribe((response) => {}
